...
public class MenukeuzeAZCMedewerker implements IActie{
    private int keuze;
    ...
    public MenukeuzeAZCMedewerker(int keuze, String titel, boolean extraLegeRegel, IActie actie){
        setKeuze(-1);
        setKeuze(keuze);
        setTitel(titel);
    ...
    public MenukeuzeAZCMedewerker(String titel, IActie actie){
        this (-1, titel, false, actie);
    }
    public MenukeuzeAZCMedewerker(int keuze, String titel, IActie actie){
