...
public class MenukeuzeVluchteling implements IActie{
    private int keuze;
    ...
    public MenukeuzeVluchteling(int keuze, String titel, boolean extraLegeRegel, IActie actie){
        setKeuze(-1);
        setKeuze(keuze);
        setTitel(titel);
    ...
    public MenukeuzeVluchteling(String titel, IActie actie){
        this (-1, titel, false, actie);
    }
    public MenukeuzeVluchteling(int keuze, String titel, IActie actie){
