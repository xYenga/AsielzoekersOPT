...
public class MenukeuzeCOAMedewerker implements IActie{
    private int keuze;
    ...
    public MenukeuzeCOAMedewerker(int keuze, String titel, boolean extraLegeRegel, IActie actie){
        setKeuze(-1);
        setKeuze(keuze);
        setTitel(titel);
    ...
    public MenukeuzeCOAMedewerker(String titel, IActie actie){
        this (-1, titel, false, actie);
    }
    public MenukeuzeCOAMedewerker(int keuze, String titel, IActie actie){
