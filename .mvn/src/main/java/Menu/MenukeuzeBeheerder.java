...
public class MenukeuzeBeheerder implements IActie{
    private int keuze;
    ...
    public MenukeuzeBeheerder(int keuze, String titel, boolean extraLegeRegel, IActie actie){
        setKeuze(-1);
        setKeuze(keuze);
        setTitel(titel);
    ...
    public MenukeuzeBeheerder(String titel, IActie actie){
        this (-1, titel, false, actie);
    }
    public MenukeuzeBeheerder(int keuze, String titel, IActie actie){
